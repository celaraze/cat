...
class ConsumablePolicy
{
    ...
    {
        return $user->can('view_any_consumable');
    }
    ...
    {
        return $user->can('view_consumable');
    }
    ...
    {
        return $user->can('create_consumable');
    }
    ...
    {
        return $user->can('update_consumable');
    }
    ...
    {
        return $user->can('delete_consumable');
    }
    ...
    {
        return $user->can('delete_any_consumable');
    }
     ...
     */
    public function replicate(User $user, Consumable $consumable): bool
    {
