...
use App\Filament\Resources\Information\PartResource\RelationManagers\HasPartRelationManager;
...
class PartResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                ImportAction::make(new PartImporter()),
    ...
    {
        return [
            'index' => PartResource\Pages\Index::route('/'),
            'create' => PartResource\Pages\Create::route('/create'),
            'edit' => PartResource\Pages\Edit::route('/{record}/edit'),
            'view' => PartResource\Pages\View::route('/{record}'),
        ];
    }
