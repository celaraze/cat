...
| [CAT Uniapp](https://github.com/celaraze/cat-uniapp)                                    | 配套的官方移动端一个应用程序，覆盖了简单场景的功能。       | 💻开发版         |
...
| [ghcr.io/celaraze/cat](https://github.com/celaraze/cat/pkgs/container/cat)              | CAT 官方发布的容器镜像，托管于Github。         | 🤖正式版，自动化集成编译 |
